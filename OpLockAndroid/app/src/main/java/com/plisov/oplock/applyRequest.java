...
public class applyRequest extends Thread{

    private String res, dopinfo;
    ...
    public void run() {
        ...
        String myURL = "http://" + ip + "/virthosts/oplock/mobile/apply.php";
        String parameters = "adress=" + adress + "&latitude=" + latitude + "&longitude=" + longitude + "&time=" + time + "&dopinfo=" + dopinfo + "&submit=1";
        byte[] data = null;
        InputStream is = null;
