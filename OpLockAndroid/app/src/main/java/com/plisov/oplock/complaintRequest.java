...
public class complaintRequest extends Thread{

    private String res, text;
    int id;
    ...
    public void run() {
        ...
        String myURL = "http://" + ip + "/virthosts/oplock/mobile/makeComplaint.php";
        String parameters = "id=" + id + "&text=" + text + "&submit=1";
        byte[] data = null;
        InputStream is = null;
